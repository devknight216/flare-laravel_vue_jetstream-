                ...
                <div class="flex flex-col w-132">
                    ...
                    <textarea
                        ...
                        class="
                            ...
                            border-gray-200
                        "
                        placeholder="Anything else you'd like to add which may help speed up the verification of your registration."
                    />
                </div>
            </div>
        </template>
        <template v-if="step == 4">
            ...
            <div class="mt-3 grid grid-cols-3">
                ...
                <div class="col-span-2">
                    ...
                    <p class="pt-2">
                        We carefully review all providers listed on FlareMetrics.io to
                        prevent malicious actors gaining publicity and to ensure
                        all your details are correct and inline with our site
                        guidelines and specifications. Monitor the email that
                        you provided for further corresponsence.
                    </p>
