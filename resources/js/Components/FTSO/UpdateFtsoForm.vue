<template>
    <body>
        ...
        <div class="mt-4 text-gray-700 text-lg font-semibold">
            Update <span class="text-indigo-700 font-bold">{{ code }}</span>
        </div>
            ...
            <div class="mt-12 md:flex items-center">
                <div class="flex flex-col">
                    ...
                    <input
                        ...
                        type="date"
                        tabindex="0"
                        aria-label="Enter established date"
                        disabled
                        class="
                            w-64
                            bg-gray-200
        ...
        <template v-if="step == 4">
            ...
            <div class="mt-3 grid grid-cols-3">
                ...
                <div class="col-span-2">
                    <h2 class="text-xl text-indigo-700 font-semibold">
                        Your application will now be reviewed.
                    </h2>
                    <p class="pt-2">
                        We carefully review all providers listed on
                        FlareMetrics.io to prevent malicious actors gaining
                        publicity and to ensure all your details are correct and
                        inline with our site guidelines and specifications.
                        Monitor the email that you provided for further
                        corresponsence.
                    </p>
                    <p class="text-gray-600 pt-2 mb-3">
                        Typically approval will be complete in 24-48 hours.
                    </p>
                    <inertia-link
                        :href="route('view.providers', code)"
                        as="button"
                        class="text-indigo-700"
                        >Return to listing</inertia-link
                    >
                </div>
            </div>
        </template>
        ...
        <div v-show="step == 3" class="text-red-600 mt-2">
...
export default {
    ...
    mounted() {
        ...
        this.form.ftsos_id = provider.id;
    ...
    methods: {
        submit() {
            ...
            axios
                .post(route("ftso.application"), formData, {
        ...
        nextStep() {
            ...
            if (!this.form.terms) {
                this.showError(
                    "You must agree to the terms before going to another step."
                );
                return;
            }
            if (this.step == 3) {
